...
let denityOfFluid = 165;
let viscosityOfFluid = 654;
...
viewOptionsSet = 
` <p>Length of the pipe : <input id="length" type="number" value="1" name="view" min="1" max="50" style="width:35px;" class="styleSelect"/> meter</p>
<p>Nominal diameter of the pipe : 
	<select name="dia" id="nomDia" class="styleSelect">
...
` <table style="font-size: 14px; font-family: verdana">
	<tr><td>Pipe Length : <span class="spanColor">${pipeLength}</span></td></tr>
	<tr><td>Nominal pipe diameter : <span class="spanColor">${nominalPipeDia}</span></td></tr
	<tr><td>Actual pipe diameter : <span class="spanColor">${actualPipeDia}</span></td></tr>
	<tr><td>Process fluid : <span class="spanColor">${processFluid}</span></td></tr>
	<tr><td>Density of process fluid : <span class="spanColor">${denityOfFluid}</span></td></tr>
	<tr><td>Viscocity of process fluid : <span class="spanColor">${viscosityOfFluid}</span></td></tr>
	<tr><td>Manometric fluid : <span class="spanColor">${manometricFluid}</span></td></tr>
	<tr><td>Manometric fluid density: <span class="spanColor">${manometricFluidDensity}</span></td></tr>
</table>`;
